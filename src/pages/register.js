...
// Your Next.js component code here
...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                // Registration successful, you can redirect the user or perform other actions here
                ...
                <form onSubmit={handleSubmit} className={styles.registerForm}>
                    ...
                    <div>
                        ...
                        <div className="flex items-center justify-center w-full">
                            <label htmlFor="image" className="flex flex-col items-center justify-center w-full h-34 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-stone-800 dark:bg-stone-600 hover:bg-stone-100 dark:border-stone-400 dark:hover:border-stone-500 dark:hover:bg-stone-600">
                                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p className="text-xs text-gray-500 dark:text-stone-900">SVG, PNG, JPG or GIF (MAX. 800x400px)</p>
                                </div>
